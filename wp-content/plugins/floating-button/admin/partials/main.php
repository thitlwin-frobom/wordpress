...
<div class="wrap">
  ...
  <p class="ideas">
    <span
      class="dashicons dashicons-megaphone"></span> <?php printf( __( 'We want to hear your Ideas about improving the plugin in  <a href="%1$s" target="_blank">our Forum</a>!',
			$this->plugin_pref ), 'https://wow-estore.com/ask/' ); ?>
  </p>
	<?php
