                        ...
                        <div class="container">
                            <div class="element">
                              <?php echo self::option($show); ?>
                                <span id="shortcode"><code>[<?php echo $this->shortcode; ?> id="<?php echo $tool_id; ?>
                                        "]</code></span>
                                <p/>
                            </div>
                        </div>
                    ...
                    <div class="inside">
                        <div class="tab-box">
                            <ul class="tab-nav">
                              <?php
                              $tab_menu = array(
                                'main' => __('Main', $this->text_domain),
                                'vertical' => __('Vertical', $this->text_domain),
                                'horizontal' => __('Horizontal', $this->text_domain),
                              );
                              $i = 1;
